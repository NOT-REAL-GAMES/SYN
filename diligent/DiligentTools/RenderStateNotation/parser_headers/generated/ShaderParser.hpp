...
inline void WriteRSN(nlohmann::json& Json, const ShaderDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.UseCombinedTextureSamplers == ShaderDesc{}.UseCombinedTextureSamplers))
        WriteRSN(Json["UseCombinedTextureSamplers"], Type.UseCombinedTextureSamplers, Allocator);

    if (!SafeStrEqual(Type.CombinedSamplerSuffix, ShaderDesc{}.CombinedSamplerSuffix))
        WriteRSN(Json["CombinedSamplerSuffix"], Type.CombinedSamplerSuffix, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, ShaderDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void WriteRSN(nlohmann::json& Json, const ShaderMacro& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, ShaderMacro& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Name",
                                          "Definition",
...
inline void WriteRSN(nlohmann::json& Json, const ShaderCreateInfo& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.LoadConstantBufferReflection == ShaderCreateInfo{}.LoadConstantBufferReflection))
        WriteRSN(Json["LoadConstantBufferReflection"], Type.LoadConstantBufferReflection, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, ShaderCreateInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "FilePath",
                                          "Source",
    ...
    if (Json.contains("LoadConstantBufferReflection"))
        ParseRSN(Json["LoadConstantBufferReflection"], Type.LoadConstantBufferReflection, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const ShaderResourceDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, ShaderResourceDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Name",
                                          "Type",
