...
NLOHMANN_JSON_SERIALIZE_ENUM_EX(
    TEXTURE_ADDRESS_MODE,
    {
        ...
        {TEXTURE_ADDRESS_MIRROR_ONCE, "MIRROR_ONCE"},
...
inline void WriteRSN(nlohmann::json& Json, const DeviceFeatures& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.ShaderResourceQueries == DeviceFeatures{}.ShaderResourceQueries))
        WriteRSN(Json["ShaderResourceQueries"], Type.ShaderResourceQueries, Allocator);
    ...
    if (!(Type.MultithreadedResourceCreation == DeviceFeatures{}.MultithreadedResourceCreation))
        WriteRSN(Json["MultithreadedResourceCreation"], Type.MultithreadedResourceCreation, Allocator);
    ...
    if (!(Type.BinaryOcclusionQueries == DeviceFeatures{}.BinaryOcclusionQueries))
        WriteRSN(Json["BinaryOcclusionQueries"], Type.BinaryOcclusionQueries, Allocator);
    ...
    if (!(Type.PipelineStatisticsQueries == DeviceFeatures{}.PipelineStatisticsQueries))
        WriteRSN(Json["PipelineStatisticsQueries"], Type.PipelineStatisticsQueries, Allocator);
    ...
    if (!(Type.TextureCompressionBC == DeviceFeatures{}.TextureCompressionBC))
        WriteRSN(Json["TextureCompressionBC"], Type.TextureCompressionBC, Allocator);

    if (!(Type.VertexPipelineUAVWritesAndAtomics == DeviceFeatures{}.VertexPipelineUAVWritesAndAtomics))
        WriteRSN(Json["VertexPipelineUAVWritesAndAtomics"], Type.VertexPipelineUAVWritesAndAtomics, Allocator);

    if (!(Type.PixelUAVWritesAndAtomics == DeviceFeatures{}.PixelUAVWritesAndAtomics))
        WriteRSN(Json["PixelUAVWritesAndAtomics"], Type.PixelUAVWritesAndAtomics, Allocator);

    if (!(Type.TextureUAVExtendedFormats == DeviceFeatures{}.TextureUAVExtendedFormats))
        WriteRSN(Json["TextureUAVExtendedFormats"], Type.TextureUAVExtendedFormats, Allocator);
    ...
    if (!(Type.ResourceBuffer16BitAccess == DeviceFeatures{}.ResourceBuffer16BitAccess))
        WriteRSN(Json["ResourceBuffer16BitAccess"], Type.ResourceBuffer16BitAccess, Allocator);

    if (!(Type.UniformBuffer16BitAccess == DeviceFeatures{}.UniformBuffer16BitAccess))
        WriteRSN(Json["UniformBuffer16BitAccess"], Type.UniformBuffer16BitAccess, Allocator);
    ...
    if (!(Type.ResourceBuffer8BitAccess == DeviceFeatures{}.ResourceBuffer8BitAccess))
        WriteRSN(Json["ResourceBuffer8BitAccess"], Type.ResourceBuffer8BitAccess, Allocator);

    if (!(Type.UniformBuffer8BitAccess == DeviceFeatures{}.UniformBuffer8BitAccess))
        WriteRSN(Json["UniformBuffer8BitAccess"], Type.UniformBuffer8BitAccess, Allocator);

    if (!(Type.ShaderResourceRuntimeArray == DeviceFeatures{}.ShaderResourceRuntimeArray))
        WriteRSN(Json["ShaderResourceRuntimeArray"], Type.ShaderResourceRuntimeArray, Allocator);
    ...
    if (!(Type.InstanceDataStepRate == DeviceFeatures{}.InstanceDataStepRate))
        WriteRSN(Json["InstanceDataStepRate"], Type.InstanceDataStepRate, Allocator);
    ...
    if (!(Type.TransferQueueTimestampQueries == DeviceFeatures{}.TransferQueueTimestampQueries))
        WriteRSN(Json["TransferQueueTimestampQueries"], Type.TransferQueueTimestampQueries, Allocator);
    ...
    if (!(Type.SubpassFramebufferFetch == DeviceFeatures{}.SubpassFramebufferFetch))
        WriteRSN(Json["SubpassFramebufferFetch"], Type.SubpassFramebufferFetch, Allocator);

    if (!(Type.TextureComponentSwizzle == DeviceFeatures{}.TextureComponentSwizzle))
        WriteRSN(Json["TextureComponentSwizzle"], Type.TextureComponentSwizzle, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, DeviceFeatures& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (Json.contains("ShaderResourceQueries"))
        ParseRSN(Json["ShaderResourceQueries"], Type.ShaderResourceQueries, Allocator);
    ...
    if (Json.contains("MultithreadedResourceCreation"))
        ParseRSN(Json["MultithreadedResourceCreation"], Type.MultithreadedResourceCreation, Allocator);
    ...
    if (Json.contains("BinaryOcclusionQueries"))
        ParseRSN(Json["BinaryOcclusionQueries"], Type.BinaryOcclusionQueries, Allocator);
    ...
    if (Json.contains("PipelineStatisticsQueries"))
        ParseRSN(Json["PipelineStatisticsQueries"], Type.PipelineStatisticsQueries, Allocator);
    ...
    if (Json.contains("TextureCompressionBC"))
        ParseRSN(Json["TextureCompressionBC"], Type.TextureCompressionBC, Allocator);

    if (Json.contains("VertexPipelineUAVWritesAndAtomics"))
        ParseRSN(Json["VertexPipelineUAVWritesAndAtomics"], Type.VertexPipelineUAVWritesAndAtomics, Allocator);

    if (Json.contains("PixelUAVWritesAndAtomics"))
        ParseRSN(Json["PixelUAVWritesAndAtomics"], Type.PixelUAVWritesAndAtomics, Allocator);

    if (Json.contains("TextureUAVExtendedFormats"))
        ParseRSN(Json["TextureUAVExtendedFormats"], Type.TextureUAVExtendedFormats, Allocator);
    ...
    if (Json.contains("ResourceBuffer16BitAccess"))
        ParseRSN(Json["ResourceBuffer16BitAccess"], Type.ResourceBuffer16BitAccess, Allocator);

    if (Json.contains("UniformBuffer16BitAccess"))
        ParseRSN(Json["UniformBuffer16BitAccess"], Type.UniformBuffer16BitAccess, Allocator);
    ...
    if (Json.contains("ResourceBuffer8BitAccess"))
        ParseRSN(Json["ResourceBuffer8BitAccess"], Type.ResourceBuffer8BitAccess, Allocator);

    if (Json.contains("UniformBuffer8BitAccess"))
        ParseRSN(Json["UniformBuffer8BitAccess"], Type.UniformBuffer8BitAccess, Allocator);

    if (Json.contains("ShaderResourceRuntimeArray"))
        ParseRSN(Json["ShaderResourceRuntimeArray"], Type.ShaderResourceRuntimeArray, Allocator);

    if (Json.contains("WaveOp"))
        ParseRSN(Json["WaveOp"], Type.WaveOp, Allocator);

    if (Json.contains("InstanceDataStepRate"))
        ParseRSN(Json["InstanceDataStepRate"], Type.InstanceDataStepRate, Allocator);
    ...
    if (Json.contains("TransferQueueTimestampQueries"))
        ParseRSN(Json["TransferQueueTimestampQueries"], Type.TransferQueueTimestampQueries, Allocator);
    ...
    if (Json.contains("SubpassFramebufferFetch"))
        ParseRSN(Json["SubpassFramebufferFetch"], Type.SubpassFramebufferFetch, Allocator);

    if (Json.contains("TextureComponentSwizzle"))
        ParseRSN(Json["TextureComponentSwizzle"], Type.TextureComponentSwizzle, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const Version& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, Version& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Major",
                                          "Minor",
...
inline void WriteRSN(nlohmann::json& Json, const TextureProperties& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.MaxTexture1DDimension == TextureProperties{}.MaxTexture1DDimension))
        WriteRSN(Json["MaxTexture1DDimension"], Type.MaxTexture1DDimension, Allocator);

    if (!(Type.MaxTexture1DArraySlices == TextureProperties{}.MaxTexture1DArraySlices))
        WriteRSN(Json["MaxTexture1DArraySlices"], Type.MaxTexture1DArraySlices, Allocator);

    if (!(Type.MaxTexture2DDimension == TextureProperties{}.MaxTexture2DDimension))
        WriteRSN(Json["MaxTexture2DDimension"], Type.MaxTexture2DDimension, Allocator);

    if (!(Type.MaxTexture2DArraySlices == TextureProperties{}.MaxTexture2DArraySlices))
        WriteRSN(Json["MaxTexture2DArraySlices"], Type.MaxTexture2DArraySlices, Allocator);

    if (!(Type.MaxTexture3DDimension == TextureProperties{}.MaxTexture3DDimension))
        WriteRSN(Json["MaxTexture3DDimension"], Type.MaxTexture3DDimension, Allocator);

    if (!(Type.MaxTextureCubeDimension == TextureProperties{}.MaxTextureCubeDimension))
        WriteRSN(Json["MaxTextureCubeDimension"], Type.MaxTextureCubeDimension, Allocator);

    if (!(Type.Texture2DMSSupported == TextureProperties{}.Texture2DMSSupported))
        WriteRSN(Json["Texture2DMSSupported"], Type.Texture2DMSSupported, Allocator);

    if (!(Type.Texture2DMSArraySupported == TextureProperties{}.Texture2DMSArraySupported))
        WriteRSN(Json["Texture2DMSArraySupported"], Type.Texture2DMSArraySupported, Allocator);

    if (!(Type.TextureViewSupported == TextureProperties{}.TextureViewSupported))
        WriteRSN(Json["TextureViewSupported"], Type.TextureViewSupported, Allocator);

    if (!(Type.CubemapArraysSupported == TextureProperties{}.CubemapArraysSupported))
        WriteRSN(Json["CubemapArraysSupported"], Type.CubemapArraysSupported, Allocator);

    if (!(Type.TextureView2DOn3DSupported == TextureProperties{}.TextureView2DOn3DSupported))
        WriteRSN(Json["TextureView2DOn3DSupported"], Type.TextureView2DOn3DSupported, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, TextureProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
    ...
    if (Json.contains("MaxTexture1DDimension"))
        ParseRSN(Json["MaxTexture1DDimension"], Type.MaxTexture1DDimension, Allocator);

    if (Json.contains("MaxTexture1DArraySlices"))
        ParseRSN(Json["MaxTexture1DArraySlices"], Type.MaxTexture1DArraySlices, Allocator);

    if (Json.contains("MaxTexture2DDimension"))
        ParseRSN(Json["MaxTexture2DDimension"], Type.MaxTexture2DDimension, Allocator);

    if (Json.contains("MaxTexture2DArraySlices"))
        ParseRSN(Json["MaxTexture2DArraySlices"], Type.MaxTexture2DArraySlices, Allocator);

    if (Json.contains("MaxTexture3DDimension"))
        ParseRSN(Json["MaxTexture3DDimension"], Type.MaxTexture3DDimension, Allocator);

    if (Json.contains("MaxTextureCubeDimension"))
        ParseRSN(Json["MaxTextureCubeDimension"], Type.MaxTextureCubeDimension, Allocator);

    if (Json.contains("Texture2DMSSupported"))
        ParseRSN(Json["Texture2DMSSupported"], Type.Texture2DMSSupported, Allocator);

    if (Json.contains("Texture2DMSArraySupported"))
        ParseRSN(Json["Texture2DMSArraySupported"], Type.Texture2DMSArraySupported, Allocator);

    if (Json.contains("TextureViewSupported"))
        ParseRSN(Json["TextureViewSupported"], Type.TextureViewSupported, Allocator);

    if (Json.contains("CubemapArraysSupported"))
        ParseRSN(Json["CubemapArraysSupported"], Type.CubemapArraysSupported, Allocator);

    if (Json.contains("TextureView2DOn3DSupported"))
        ParseRSN(Json["TextureView2DOn3DSupported"], Type.TextureView2DOn3DSupported, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const SamplerProperties& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.BorderSamplingModeSupported == SamplerProperties{}.BorderSamplingModeSupported))
        WriteRSN(Json["BorderSamplingModeSupported"], Type.BorderSamplingModeSupported, Allocator);

    if (!(Type.AnisotropicFilteringSupported == SamplerProperties{}.AnisotropicFilteringSupported))
        WriteRSN(Json["AnisotropicFilteringSupported"], Type.AnisotropicFilteringSupported, Allocator);
...
inline void ParseRSN(const nlohmann::json& Json, SamplerProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
    ...
    if (Json.contains("BorderSamplingModeSupported"))
        ParseRSN(Json["BorderSamplingModeSupported"], Type.BorderSamplingModeSupported, Allocator);

    if (Json.contains("AnisotropicFilteringSupported"))
        ParseRSN(Json["AnisotropicFilteringSupported"], Type.AnisotropicFilteringSupported, Allocator);

    if (Json.contains("LODBiasSupported"))
        ParseRSN(Json["LODBiasSupported"], Type.LODBiasSupported, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const WaveOpProperties& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, WaveOpProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "MinSize",
                                          "MaxSize",
...
inline void WriteRSN(nlohmann::json& Json, const BufferProperties& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.ConstantBufferOffsetAlignment == BufferProperties{}.ConstantBufferOffsetAlignment))
        WriteRSN(Json["ConstantBufferOffsetAlignment"], Type.ConstantBufferOffsetAlignment, Allocator);

    if (!(Type.StructuredBufferOffsetAlignment == BufferProperties{}.StructuredBufferOffsetAlignment))
        WriteRSN(Json["StructuredBufferOffsetAlignment"], Type.StructuredBufferOffsetAlignment, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, BufferProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
    ...
    if (Json.contains("ConstantBufferOffsetAlignment"))
        ParseRSN(Json["ConstantBufferOffsetAlignment"], Type.ConstantBufferOffsetAlignment, Allocator);

    if (Json.contains("StructuredBufferOffsetAlignment"))
        ParseRSN(Json["StructuredBufferOffsetAlignment"], Type.StructuredBufferOffsetAlignment, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const RayTracingProperties& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.ShaderGroupHandleSize == RayTracingProperties{}.ShaderGroupHandleSize))
        WriteRSN(Json["ShaderGroupHandleSize"], Type.ShaderGroupHandleSize, Allocator);

    if (!(Type.MaxShaderRecordStride == RayTracingProperties{}.MaxShaderRecordStride))
        WriteRSN(Json["MaxShaderRecordStride"], Type.MaxShaderRecordStride, Allocator);

    if (!(Type.ShaderGroupBaseAlignment == RayTracingProperties{}.ShaderGroupBaseAlignment))
        WriteRSN(Json["ShaderGroupBaseAlignment"], Type.ShaderGroupBaseAlignment, Allocator);
    ...
    if (!(Type.MaxPrimitivesPerBLAS == RayTracingProperties{}.MaxPrimitivesPerBLAS))
        WriteRSN(Json["MaxPrimitivesPerBLAS"], Type.MaxPrimitivesPerBLAS, Allocator);

    if (!(Type.MaxGeometriesPerBLAS == RayTracingProperties{}.MaxGeometriesPerBLAS))
        WriteRSN(Json["MaxGeometriesPerBLAS"], Type.MaxGeometriesPerBLAS, Allocator);

    if (!(Type.VertexBufferAlignment == RayTracingProperties{}.VertexBufferAlignment))
        WriteRSN(Json["VertexBufferAlignment"], Type.VertexBufferAlignment, Allocator);

    if (!(Type.IndexBufferAlignment == RayTracingProperties{}.IndexBufferAlignment))
        WriteRSN(Json["IndexBufferAlignment"], Type.IndexBufferAlignment, Allocator);

    if (!(Type.TransformBufferAlignment == RayTracingProperties{}.TransformBufferAlignment))
        WriteRSN(Json["TransformBufferAlignment"], Type.TransformBufferAlignment, Allocator);
    ...
    if (!(Type.ScratchBufferAlignment == RayTracingProperties{}.ScratchBufferAlignment))
        WriteRSN(Json["ScratchBufferAlignment"], Type.ScratchBufferAlignment, Allocator);

    if (!(Type.InstanceBufferAlignment == RayTracingProperties{}.InstanceBufferAlignment))
        WriteRSN(Json["InstanceBufferAlignment"], Type.InstanceBufferAlignment, Allocator);

    if (!(Type.CapFlags == RayTracingProperties{}.CapFlags))
        SerializeBitwiseEnum(Json["CapFlags"], Type.CapFlags, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, RayTracingProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "MaxRecursionDepth",
    ...
    if (Json.contains("ShaderGroupHandleSize"))
        ParseRSN(Json["ShaderGroupHandleSize"], Type.ShaderGroupHandleSize, Allocator);

    if (Json.contains("MaxShaderRecordStride"))
        ParseRSN(Json["MaxShaderRecordStride"], Type.MaxShaderRecordStride, Allocator);

    if (Json.contains("ShaderGroupBaseAlignment"))
        ParseRSN(Json["ShaderGroupBaseAlignment"], Type.ShaderGroupBaseAlignment, Allocator);
    ...
    if (Json.contains("MaxPrimitivesPerBLAS"))
        ParseRSN(Json["MaxPrimitivesPerBLAS"], Type.MaxPrimitivesPerBLAS, Allocator);

    if (Json.contains("MaxGeometriesPerBLAS"))
        ParseRSN(Json["MaxGeometriesPerBLAS"], Type.MaxGeometriesPerBLAS, Allocator);

    if (Json.contains("VertexBufferAlignment"))
        ParseRSN(Json["VertexBufferAlignment"], Type.VertexBufferAlignment, Allocator);

    if (Json.contains("IndexBufferAlignment"))
        ParseRSN(Json["IndexBufferAlignment"], Type.IndexBufferAlignment, Allocator);

    if (Json.contains("TransformBufferAlignment"))
        ParseRSN(Json["TransformBufferAlignment"], Type.TransformBufferAlignment, Allocator);
    ...
    if (Json.contains("ScratchBufferAlignment"))
        ParseRSN(Json["ScratchBufferAlignment"], Type.ScratchBufferAlignment, Allocator);

    if (Json.contains("InstanceBufferAlignment"))
        ParseRSN(Json["InstanceBufferAlignment"], Type.InstanceBufferAlignment, Allocator);

    if (Json.contains("CapFlags"))
        DeserializeBitwiseEnum(Json["CapFlags"], Type.CapFlags, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const MeshShaderProperties& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.MaxThreadGroupCountX == MeshShaderProperties{}.MaxThreadGroupCountX))
        WriteRSN(Json["MaxThreadGroupCountX"], Type.MaxThreadGroupCountX, Allocator);

    if (!(Type.MaxThreadGroupCountY == MeshShaderProperties{}.MaxThreadGroupCountY))
        WriteRSN(Json["MaxThreadGroupCountY"], Type.MaxThreadGroupCountY, Allocator);

    if (!(Type.MaxThreadGroupCountZ == MeshShaderProperties{}.MaxThreadGroupCountZ))
        WriteRSN(Json["MaxThreadGroupCountZ"], Type.MaxThreadGroupCountZ, Allocator);

    if (!(Type.MaxThreadGroupTotalCount == MeshShaderProperties{}.MaxThreadGroupTotalCount))
        WriteRSN(Json["MaxThreadGroupTotalCount"], Type.MaxThreadGroupTotalCount, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, MeshShaderProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
    ...
    if (Json.contains("MaxThreadGroupCountX"))
        ParseRSN(Json["MaxThreadGroupCountX"], Type.MaxThreadGroupCountX, Allocator);

    if (Json.contains("MaxThreadGroupCountY"))
        ParseRSN(Json["MaxThreadGroupCountY"], Type.MaxThreadGroupCountY, Allocator);

    if (Json.contains("MaxThreadGroupCountZ"))
        ParseRSN(Json["MaxThreadGroupCountZ"], Type.MaxThreadGroupCountZ, Allocator);

    if (Json.contains("MaxThreadGroupTotalCount"))
        ParseRSN(Json["MaxThreadGroupTotalCount"], Type.MaxThreadGroupTotalCount, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const ComputeShaderProperties& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.MaxThreadGroupInvocations == ComputeShaderProperties{}.MaxThreadGroupInvocations))
        WriteRSN(Json["MaxThreadGroupInvocations"], Type.MaxThreadGroupInvocations, Allocator);
...
inline void ParseRSN(const nlohmann::json& Json, ComputeShaderProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "SharedMemorySize",
    ...
    if (Json.contains("MaxThreadGroupInvocations"))
        ParseRSN(Json["MaxThreadGroupInvocations"], Type.MaxThreadGroupInvocations, Allocator);
...
inline void WriteRSN(nlohmann::json& Json, const NDCAttribs& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, NDCAttribs& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "MinZ",
                                          "ZtoDepthScale",
...
inline void WriteRSN(nlohmann::json& Json, const RenderDeviceShaderVersionInfo& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, RenderDeviceShaderVersionInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "HLSL",
                                          "GLSL",
...
inline void WriteRSN(nlohmann::json& Json, const RenderDeviceInfo& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, RenderDeviceInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Type",
                                          "APIVersion",
...
inline void WriteRSN(nlohmann::json& Json, const AdapterMemoryInfo& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, AdapterMemoryInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "LocalMemory",
                                          "HostVisibleMemory",
...
inline void WriteRSN(nlohmann::json& Json, const ShadingRateMode& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, ShadingRateMode& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Rate",
                                          "SampleBits",
...
inline void WriteRSN(nlohmann::json& Json, const ShadingRateProperties& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.ShadingRateTextureAccess == ShadingRateProperties{}.ShadingRateTextureAccess))
        WriteRSN(Json["ShadingRateTextureAccess"], Type.ShadingRateTextureAccess, Allocator);
    ...
    if (!(Type.MaxSabsampledArraySlices == ShadingRateProperties{}.MaxSabsampledArraySlices))
        WriteRSN(Json["MaxSabsampledArraySlices"], Type.MaxSabsampledArraySlices, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, ShadingRateProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "ShadingRates",
                                          "NumShadingRates",
    ...
    if (Json.contains("ShadingRateTextureAccess"))
        ParseRSN(Json["ShadingRateTextureAccess"], Type.ShadingRateTextureAccess, Allocator);
    ...
    if (Json.contains("MaxSabsampledArraySlices"))
        ParseRSN(Json["MaxSabsampledArraySlices"], Type.MaxSabsampledArraySlices, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const DrawCommandProperties& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.MaxDrawIndirectCount == DrawCommandProperties{}.MaxDrawIndirectCount))
        WriteRSN(Json["MaxDrawIndirectCount"], Type.MaxDrawIndirectCount, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, DrawCommandProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "CapFlags",
                                          "MaxIndexValue",
    ...
    if (Json.contains("MaxDrawIndirectCount"))
        ParseRSN(Json["MaxDrawIndirectCount"], Type.MaxDrawIndirectCount, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const SparseResourceProperties& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, SparseResourceProperties& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "AddressSpaceSize",
                                          "ResourceSpaceSize",
...
inline void WriteRSN(nlohmann::json& Json, const CommandQueueInfo& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, CommandQueueInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "QueueType",
                                          "MaxDeviceContexts",
...
inline void WriteRSN(nlohmann::json& Json, const GraphicsAdapterInfo& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, GraphicsAdapterInfo& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Description",
                                          "Type",
