...
inline void WriteRSN(nlohmann::json& Json, const RasterizerStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.FrontCounterClockwise == RasterizerStateDesc{}.FrontCounterClockwise))
        WriteRSN(Json["FrontCounterClockwise"], Type.FrontCounterClockwise, Allocator);
    ...
    if (!(Type.AntialiasedLineEnable == RasterizerStateDesc{}.AntialiasedLineEnable))
        WriteRSN(Json["AntialiasedLineEnable"], Type.AntialiasedLineEnable, Allocator);
    ...
    if (!(Type.SlopeScaledDepthBias == RasterizerStateDesc{}.SlopeScaledDepthBias))
        WriteRSN(Json["SlopeScaledDepthBias"], Type.SlopeScaledDepthBias, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, RasterizerStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (Json.contains("FrontCounterClockwise"))
        ParseRSN(Json["FrontCounterClockwise"], Type.FrontCounterClockwise, Allocator);
    ...
    if (Json.contains("AntialiasedLineEnable"))
        ParseRSN(Json["AntialiasedLineEnable"], Type.AntialiasedLineEnable, Allocator);
    ...
    if (Json.contains("SlopeScaledDepthBias"))
        ParseRSN(Json["SlopeScaledDepthBias"], Type.SlopeScaledDepthBias, Allocator);
}
