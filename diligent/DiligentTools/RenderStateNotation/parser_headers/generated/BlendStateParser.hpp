...
inline void WriteRSN(nlohmann::json& Json, const RenderTargetBlendDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.LogicOperationEnable == RenderTargetBlendDesc{}.LogicOperationEnable))
        WriteRSN(Json["LogicOperationEnable"], Type.LogicOperationEnable, Allocator);
    ...
    if (!(Type.RenderTargetWriteMask == RenderTargetBlendDesc{}.RenderTargetWriteMask))
        SerializeBitwiseEnum(Json["RenderTargetWriteMask"], Type.RenderTargetWriteMask, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, RenderTargetBlendDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (Json.contains("LogicOperationEnable"))
        ParseRSN(Json["LogicOperationEnable"], Type.LogicOperationEnable, Allocator);
    ...
    if (Json.contains("RenderTargetWriteMask"))
        DeserializeBitwiseEnum(Json["RenderTargetWriteMask"], Type.RenderTargetWriteMask, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const BlendStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.AlphaToCoverageEnable == BlendStateDesc{}.AlphaToCoverageEnable))
        WriteRSN(Json["AlphaToCoverageEnable"], Type.AlphaToCoverageEnable, Allocator);

    if (!(Type.IndependentBlendEnable == BlendStateDesc{}.IndependentBlendEnable))
        WriteRSN(Json["IndependentBlendEnable"], Type.IndependentBlendEnable, Allocator);
...
inline void ParseRSN(const nlohmann::json& Json, BlendStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
    ...
    if (Json.contains("AlphaToCoverageEnable"))
        ParseRSN(Json["AlphaToCoverageEnable"], Type.AlphaToCoverageEnable, Allocator);

    if (Json.contains("IndependentBlendEnable"))
        ParseRSN(Json["IndependentBlendEnable"], Type.IndependentBlendEnable, Allocator);
