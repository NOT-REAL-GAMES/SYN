...
inline void WriteRSN(nlohmann::json& Json, const SampleDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, SampleDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void WriteRSN(nlohmann::json& Json, const ShaderResourceVariableDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, ShaderResourceVariableDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Name",
                                          "ShaderStages",
...
inline void WriteRSN(nlohmann::json& Json, const PipelineResourceLayoutDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, PipelineResourceLayoutDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "DefaultVariableType",
...
inline void WriteRSN(nlohmann::json& Json, const GraphicsPipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, GraphicsPipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "BlendDesc",
                                          "SampleMask",
...
inline void WriteRSN(nlohmann::json& Json, const RayTracingPipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, RayTracingPipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "ShaderRecordSize",
                                          "MaxRecursionDepth",
...
inline void WriteRSN(nlohmann::json& Json, const PipelineStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    ...
    if (!(Type.ImmediateContextMask == PipelineStateDesc{}.ImmediateContextMask))
        WriteRSN(Json["ImmediateContextMask"], Type.ImmediateContextMask, Allocator);

    if (!(Type.ResourceLayout == PipelineStateDesc{}.ResourceLayout))
        WriteRSN(Json["ResourceLayout"], Type.ResourceLayout, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, PipelineStateDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "Name",
                                          "PipelineType",
    ...
    if (Json.contains("ImmediateContextMask"))
        ParseRSN(Json["ImmediateContextMask"], Type.ImmediateContextMask, Allocator);

    if (Json.contains("ResourceLayout"))
        ParseRSN(Json["ResourceLayout"], Type.ResourceLayout, Allocator);
}

inline void WriteRSN(nlohmann::json& Json, const TilePipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, TilePipelineDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "NumRenderTargets",
                                          "SampleCount",
