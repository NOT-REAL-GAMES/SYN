...
inline void WriteRSN(nlohmann::json& Json, const LayoutElement& Type, DynamicLinearAllocator& Allocator)
{
...
inline void ParseRSN(const nlohmann::json& Json, LayoutElement& Type, DynamicLinearAllocator& Allocator)
{
...
inline void WriteRSN(nlohmann::json& Json, const InputLayoutDesc& Type, DynamicLinearAllocator& Allocator)
{
    if (!(Type.LayoutElements == InputLayoutDesc{}.LayoutElements))
        WriteRSN(Json["LayoutElements"], Type.LayoutElements, Type.NumElements, Allocator);
}

inline void ParseRSN(const nlohmann::json& Json, InputLayoutDesc& Type, DynamicLinearAllocator& Allocator)
{
    NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                          "LayoutElements",
                                          "NumElements",
    ...
    if (Json.contains("LayoutElements"))
        ParseRSN(Json["LayoutElements"], Type.LayoutElements, Type.NumElements, Allocator);
}
