...
inline void WriteRSN(nlohmann::json &Json, const ImmutableSamplerDesc &Type,
  ...
  if (!SafeStrEqual(Type.SamplerOrTextureName,
                    ImmutableSamplerDesc{}.SamplerOrTextureName))
    WriteRSN(Json["SamplerOrTextureName"], Type.SamplerOrTextureName,
             Allocator);
...
inline void ParseRSN(const nlohmann::json &Json, ImmutableSamplerDesc &Type,
                     DynamicLinearAllocator &Allocator) {
  ...
  if (Json.contains("SamplerOrTextureName"))
    ParseRSN(Json["SamplerOrTextureName"], Type.SamplerOrTextureName,
             Allocator);
...
inline void WriteRSN(nlohmann::json &Json, const PipelineResourceDesc &Type,
                     DynamicLinearAllocator &Allocator) {
...
inline void ParseRSN(const nlohmann::json &Json, PipelineResourceDesc &Type,
                     DynamicLinearAllocator &Allocator) {
  NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                        "Name",
                                        "ShaderStages",
...
inline void WriteRSN(nlohmann::json &Json,
                     const PipelineResourceSignatureDesc &Type,
                     DynamicLinearAllocator &Allocator) {
  ...
  if (!(Type.ImmutableSamplers ==
        PipelineResourceSignatureDesc{}.ImmutableSamplers))
  ...
  if (!(Type.UseCombinedTextureSamplers ==
        PipelineResourceSignatureDesc{}.UseCombinedTextureSamplers))
