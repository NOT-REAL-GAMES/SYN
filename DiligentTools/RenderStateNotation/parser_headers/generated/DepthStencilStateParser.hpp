...
NLOHMANN_JSON_SERIALIZE_ENUM_EX(STENCIL_OP,
                                {
...
inline void WriteRSN(nlohmann::json &Json, const StencilOpDesc &Type,
...
inline void ParseRSN(const nlohmann::json &Json, StencilOpDesc &Type,
                     DynamicLinearAllocator &Allocator) {
...
inline void WriteRSN(nlohmann::json &Json, const DepthStencilStateDesc &Type,
                     DynamicLinearAllocator &Allocator) {
...
inline void ParseRSN(const nlohmann::json &Json, DepthStencilStateDesc &Type,
                     DynamicLinearAllocator &Allocator) {
  NLOHMANN_JSON_VALIDATE_KEYS(Json, {
                                        "DepthEnable",
                                        "DepthWriteEnable",
